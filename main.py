...
from utils.set_up_params import set_default_params, set_final_parameters, set_speed, set_login_level


def get_default_params():
    return set_default_params() | set_final_parameters() | set_speed() | set_login_level()
